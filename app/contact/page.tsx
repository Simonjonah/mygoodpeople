  ...
  return (
    <div className="flex flex-col w-full bg-slate-50 min-h-screen">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-slate-300 text-sm leading-relaxed">Financial District, 123 Business Blvd<br/>City Name, State, Zip</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 p-12 lg:p-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className="bg-[#0A192F] text-white px-8 py-4 rounded font-bold hover:bg-[#112240] transition-colors shadow-lg disabled:opacity-70 flex items-center justify-center min-w-[200px]"
                >
      ...
      <section className="h-[400px] w-full bg-slate-300 relative">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193595.15830869428!2d-74.119763973046!3d40.69766374874431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY!5e0!3m2!1sen!2sus!4v1684346938927!5m2!1sen!2sus" 
          width="100%" 
          height="100%" 
          style={{ border: 0 }} 
          allowFullScreen 
